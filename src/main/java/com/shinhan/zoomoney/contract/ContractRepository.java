...
//	//Optional<ContractEntity> findFirstByMember_MemberNumAndContractStatus(Integer memberNum, Boolean contractStatus);
//    
    ...
    Optional<ContractEntity> findFirstByMember_MemberNumAndContractStatusOrderByContractDateDesc(int childNum, boolean contractStatus);
    Optional<ContractEntity> findFirstByMember_MemberNumAndContractStatusOrderByContractNumDesc(int childNum, boolean contractStatus);
   
    // 과거 계약서 목록 조회
    List<ContractEntity> findAllByMember_MemberNumAndContractStatusOrderByContractDateDesc(int childNum, boolean contractStatus);    
